      ...
      .on("mouseover", function(d) {  
        ...
        tooltip.html(function() {
          ...
          if(result[0]){
            ...
            return '<b><span style="line-height:2">' + result[0]['area_name'] + ', ' + result[0]['state'] + '</span></b>' + 
            '<br>Summary Statistic 1: ' + result[0].bachelorsOrHigher +  
            '<br>Summary Statistic 2: ' + result[0].bachelorsOrHigher + 
            '<br>Summary Statistic 3: ' + result[0].bachelorsOrHigher
          }
          //could not find a matching fips id in the data
          return 0
        })
